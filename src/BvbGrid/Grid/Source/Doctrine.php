<?php
namespace BvbGrid\Grid\Source;

use BvbGrid\Grid\Source\Db\DbAbstract;
use BvbGrid\Grid\Source\Doctrine\Exception as ExceptionDoctrine;
        ...
        implements SourceInterface
{
     ...
     * @param string $order
     * @param bool $reset
     * @return BvbGrid\Grid\Source\Doctrine
     */
    ...
    public function getSelectOrder()
    {
         ...
         *
         * @see BvbGrid\Grid\Source\Zend\Select::getSelectOrder()
         */
        return $result[0];
    }
     ...
     * @see BvbGrid\Grid\Source\SourceInterface::quoteValue()
     */
     ...
     * to be used when loading the BvbGrid\Grid\Form
     *
     * @param array $cols
     * @param array $info
     * @return array
     ...
     * from within the BvbGrid\Grid\Data class, you will need to
