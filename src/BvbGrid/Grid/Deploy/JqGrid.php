...
class JqGrid extends Grid implements DeployInterface
{
    ...
    /**
     * BvbGrid\Grid\Deploy\JqGrid own options to apply
     *
     * @var array
     */
    ...
    public function __construct (array $options = array())
    {
        ...
        // TODO fix for property with same name in BvbGrid\Grid
        $this->_view = null;
    ...
    {
        trigger_error("BvbGrid\Grid\Deploy\JqGrid::ajax() is deprecated, use setAjax() instead. Function will be removed in later versions.", E_USER_DEPRECATED);
        $this->setAjax($id);
    }
     ...
     *
     * @return BvbGrid\Grid\Deploy\JqGrid
     */
    ...
    /**
     * Set BvbGrid\Grid\Deploy\JqGrid own options (merging with old options)
     *
     * @param array $options set BvbGrid\Grid\Deploy\JqGrid
     *
     * @return BvbGrid\Grid\Deploy\JqGrid
     */
    ...
    /**
     * Set value to one parameter from BvbGrid\Grid\Deploy\JqGrid domain
     *
     * @param string $var   name of property to set with value
     * @param mixed  $value value
     *
    ...
    /**
     * Return value of parameter from BvbGrid\Grid\Deploy\JqGrid domain
     *
     * @param string $var     variable name
     * @param mixed  $default value to return if option is not set
     *
    ...
    {
        // TODO __call function in BvbGrid\Grid should ignore such call
...
HTML;
     ...
     * 2. special BvbGrid\Grid\Deploy\JqGrid options (jqg array)
    ...
    public function prepareOptions()
    {
        ...
        // override with options defined on BvbGrid\Grid level
...
JS;
    ...
    // Following functions could go to BvbGrid\Grid
    /**
    ...
    {
        // TODO this should be BvbGrid\Formatter class and it should not be static there
...
class JqGridCommand
{
     ...
     * Constructor
     *
     * @param BvbGrid\Grid\Deploy\JqGrid $grid grid object
     */
